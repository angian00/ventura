...
{
    public class ViewManager_old : MonoBehaviour
    {
        public enum ViewId
        {
            Map,
        ...
        void Awake()
        {
            ...
            //_inputHandlers.Add(ViewId.Character, new SkillsInputHandler(this));
        ...
        private void switchTo(ViewId targetView)
        {
        ...
        private void toggleView(ViewId targetView)
        {
            if (_activeView == targetView)
                switchTo(ViewId.Map);
            else
        ...
        private void showPopup(string title, SystemRequest.Command command)
        {
        ...
        {
            hideView(ViewId.Popup); //FIXME: let Popup hide himself
